    ...
    public class KryptonRenderHelper
    {
        ...
        public void BufferAddShadowHull(ShadowHull hull)
        {
            ...
            for (int i = 0; i < hull.NumPoints; i++)
            {
                ...
                //debug assegnazione delle altezze dei punti ai vertici
                //hullVertex.axis = new Mitten.VAxis(0, 0);// hull.Points.axis;
        ...
        public void ShadowsReset()
        {
            mShadowHullVertices.Clear();
            mShadowHullIndicies.Clear();
        }
