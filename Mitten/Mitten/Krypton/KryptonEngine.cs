...
namespace Krypton
{
    ...
    public class KryptonEngine : DrawableGameComponent
    {
        ...
        private Color mAmbientColor = new Color(128,128,128);
        ...
        /// <summary>
        /// Gets or sets a value indicating weither or not to use Globals.spriteBatch's matrix when drawing lightmaps
        /// </summary>
        ...
        private Matrix LightmapMatrixGet()
        {
            if (this.mspriteBatchCompatabilityEnabled)
            {
                ...
                // This is the default matrix used to render sprites via Globals.spriteBatch
                ...
                // Return krypton's matrix, compensated for use with Globals.spriteBatch
