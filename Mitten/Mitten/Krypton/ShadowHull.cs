...
namespace Krypton
{
    ...
    public class ShadowHull
    {
        ...
        public static ShadowHull CreateCircle(float radius, int sides) //debug l ultimo parametro non esisteva
        {
            // Validate input
        ...
        { get { return axis; } set { axis = value; } }
    }
}
