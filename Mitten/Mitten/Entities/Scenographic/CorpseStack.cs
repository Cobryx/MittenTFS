...
namespace Mitten
{
    public class CorpseStack : InteractiveScenography
    {
        Random r;
        public CorpseStack(Vector2 position, float rotation, int type, int subtype, ref SpriteSheet[] sheet, ref Dungeon dungeon)
            : base(position, rotation, type, subtype, ref sheet, ref dungeon)
        {
            ...
            sheetIndex = (int)sheetIndexes.corpsestack;
