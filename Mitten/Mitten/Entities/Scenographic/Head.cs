...
namespace Mitten
{
    public class Head : InteractiveScenography
    {
        Random r;
        public Head(Vector2 position, float rotation, int type, int subtype, ref SpriteSheet[] sheet, ref Dungeon dungeon)
            : base(position, rotation, type, subtype, ref sheet, ref dungeon)
        {
            ...
            sheetIndex = (int)sheetIndexes.head;
